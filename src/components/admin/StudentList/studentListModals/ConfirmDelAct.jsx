...
const ConfirmDelAct = ({ onClose, onConfirm }) => {
  return (
    <div>
      ...
      <div className='p-2 font-serif flex flex-col justify-center items-center'>
        <h3 className='text-[24px] text-center'>
          This action is irreversible, and all related data will also be
          deleted. Are you sure you want to proceed with deletion?
        </h3>
